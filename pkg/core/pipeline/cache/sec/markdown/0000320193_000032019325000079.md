...
The Company's effective tax rate for 2025 was lower compared to 2024 due to a \$10.7 billion year-over-year decrease in the provision for income taxes related to the State Aid Decision (refer to Note 7, "Income Taxes" in the 
[TABLE: NOTES]
Notes to Consolidated Financial Statements in Part II, Item 8 of this Form 10-K) and the impact of changes in unrecognized tax benefits, partially offset by a change in valuation allowance and a higher effective tax rate on foreign earnings.
...
[TABLE: INCOME_STATEMENT]
Income Statement Expenses ("ASU 2024-03") and in January 2025, the FASB issued ASU No. 2025-01, 
[TABLE: INCOME_STATEMENT]
...
Consolidated 
[TABLE: BALANCE_SHEET]
Balance Sheets at fair value. The accounting treatment for derivative gains and losses is based on intended use and hedge designation.
...
Consolidated 
[TABLE: INCOME_STATEMENT]
Statements of Operations line item to which the hedge relates along with offsetting losses and gains related to the change in value of the hedged item.
...
Consolidated 
[TABLE: INCOME_STATEMENT]
Statements of Operations line item to which the hedge relates. Changes in the fair value of amounts excluded from the assessment of hedge effectiveness are recognized in other comprehensive income/(loss).
...
Consolidated 
[TABLE: CASH_FLOW_STATEMENT]
Statements of Cash Flows as the items being hedged, which are generally classified as operating activities.
...
As of September 27, 2025 and September 28, 2024, the carrying amount of the Company's [[current and non-current term debt]{style="-sec-ix-hidden:f-637"} subject to fair value hedges was \$12.6 billion and \$13.5 billion, respectively.]{style="color:#000000;font-family:'Helvetica',sans-serif;font-size:9pt;font-weight:400;line-height:120%"}
...
consolidated 
[TABLE: INCOME_STATEMENT]
statements of operations, comprehensive income, shareholders' equity and cash flows for each of the three years in the period ended September 27, 2025, and the related notes and our report dated October 31, 2025 expressed an unqualified opinion thereon.
